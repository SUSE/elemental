...
// These are the paths form the ignition spec we explicitly mark as not supported
...
// ToIgn3_5Bytes translates from a v0.6 Butane config to a v3.5.0 Ignition config. It returns a report of any errors or
